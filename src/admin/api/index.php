...
function updateUser($db, $data) {
    ...
    if (isset($data['email']) && $data['email'] !== '') {
        ...
        $dup->bindValue(':email', $newEmail, PDO::PARAM_STR);
    ...
    // If no fields were provided, return 200 with no change
    if (empty($fields)) {
...
function changePassword($db, $data) {
    ...
    $update->bindValue(':password', $hashedNew, PDO::PARAM_STR);
